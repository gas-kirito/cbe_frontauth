...
h2. Relevant modifications in this fork

Documentation ported from HTML tags to Textile.
Edit `include_once( txpath.'/lib/txplib_admin.php' )` to make the plugin compatible with Textpattern 4.8.
This repo also include *cbe_members.php* which is a dependency for *cbe_frontauth*.
...
See "CONTRIBUTING":https://github.com/gas-kirito/cbe_frontauth/blob/master/CONTRIBUTING.textile for details.
